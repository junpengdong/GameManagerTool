...
Core.init = function(){
    ...
    //系统设置处理
    $('.task-begin').bind('click',function(){
        //展示自定义右键菜单
...
var GetTaskSystem = function(obj){
    if(!_cache.TaskSystem){
        _cache.TaskSystem = $('<div class="popup-menu task-menu" style="z-index:99999;bottom:30px;display:none;left: 2px"><ul><li><a menu="close" href="javascript:;" onclick="logout()">注销用户</a></li></ul></div>');
...
var logout = function(){
    ...
    window.parent.location = './html/pages/login.html';
}
